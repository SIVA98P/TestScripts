...
public class Base_class {
	...
	// LocatorandClickByID
	public static void findElementByIdAndClick(String attributevalue) {
	...
	// Random Chooser
		...
		public static void randomchooser(List<WebElement> element) {
			Random randomChooser = new Random();
			jsClick(element.get(randomChooser.nextInt(element.size())));
		}
	...
	// Webdriver Wait
	public boolean waitForElementToBeClickableBool(WebDriver driver, WebElement webElement, Duration duration) {
		boolean flag = false;
		try {
			new WebDriverWait(driver,10).ignoring(Exception.class)
	...
	public static void UpdateData(String sheetname, int rownum, int cellnum, String olddata,
			String newdata) throws IOException {
		String filepath = System.getProperty("user.dir") + "/target/bt_DO_DB.xlsx";
		String res = null;
		File file = new File(filepath);
		FileInputStream stream = new FileInputStream(file);
		Workbook workbook = new XSSFWorkbook(stream);
	...
	// excelSheet
	public static String getdataforNoOfInputs(String filepath, String SheetName, int rowstart, int cellstart,
			int rowend, int cellend) throws Exception {
		String res = null;
		File file = new File(filepath);
		FileInputStream stream = new FileInputStream(file);
	...
	public static String getDataFromExcel(String SheetName, int rownum, int cellnum) throws IOException {
		String path = System.getProperty("user.dir") + "/target/CATIEWeb_DB.xlsx";
		String res = null;
		File file = new File(path);
		FileInputStream stream = new FileInputStream(file);
